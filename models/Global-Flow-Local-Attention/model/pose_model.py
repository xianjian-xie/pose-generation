...
class Pose(BaseModel):
    ...
    def __init__(self, opt):
        ...
        self.visual_names = ['input_P1','input_P2', 'input_BP1', 'input_BP2', 'img_gen', 'flow_fields', 'masks']
        ...
        elif self.opt.dataset_mode== 'hmubi':
            self.net_D = network.define_d(opt, ndf=32, img_f=128, layers=3, use_spect=opt.use_spect_d)
    ...
    def set_input(self, input):
        ...
        self.input = input
        input_P1, input_BP1, input_M1 = input['P1'], input['BP1'], input['M1']
        input_P2, input_BP2, input_M2 = input['P2'], input['BP2'], input['M2']
        

        if len(self.gpu_ids) > 0:
            self.input_P1 = input_P1.cuda(self.gpu_ids[0])
            self.input_BP1 = input_BP1.cuda(self.gpu_ids[0])
            self.input_M1 = input_M1.cuda(self.gpu_ids[0])
            self.input_P2 = input_P2.cuda(self.gpu_ids[0])
            self.input_BP2 = input_BP2.cuda(self.gpu_ids[0])
            self.input_M2 = input_M2.cuda(self.gpu_ids[0])        
    ...
    def test(self):
        ...
        img_gen, flow_fields, masks = self.net_G(self.input_P1, self.input_BP1, self.input_BP2, self.input_M2)
    ...
    def forward(self):
        ...
        self.img_gen, self.flow_fields, self.masks = self.net_G(self.input_P1, self.input_BP1, self.input_BP2, self.input_M2)
        self.target_mask_gen = self.input_M2
